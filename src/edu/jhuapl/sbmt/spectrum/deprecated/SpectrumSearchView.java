...
//import edu.jhuapl.sbmt.spectrum.model.core.BaseSpectrumSearchModel;
...
//
//
//    public SpectrumSearchView(ModelManager modelManager, PickManager pickManager2, Renderer renderer, ISpectralInstrument instrument, BaseSpectrumSearchModel model)
//    {
//
...
//        model.getSearchParameters().setStartDate(start.toDate());
...
//        model.getSearchParameters().setEndDate(end.toDate());
